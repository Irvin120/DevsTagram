        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                ...
                @auth
                    ...
                    @if (session('mensaje'))
                        <div class="bg-green-500 rounded-lg mb-6 text-white text-center uppercase fond-bold">
                            {{ session('mensaje') }}
                        </div>
                    @endif
                    ...
                    <form action="{{ route('comentarios.store', ['post' => $post, 'user' => $user]) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="comentario" name="comentario" placeholder="Agrega un Comentarios"
